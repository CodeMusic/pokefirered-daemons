...
# DAEMONS: the layouts .incbin their map.bin and border.bin, and nothing else
# told make so -- a redrawn map never reached the ROM until layouts.json changed.
$(DATA_ASM_BUILDDIR)/maps.o: $(wildcard $(LAYOUTS_DIR)/*/*.bin)
