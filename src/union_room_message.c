...
ALIGNED(4) static const u8 sText_OtherTrainerUnavailableNow[] = _("The other USER doesn't appear to\nbe available now…\p");
ALIGNED(4) static const u8 sText_CantTransmitTrainerTooFar[] = _("You can't transmit with a USER who\nis too far away.\p");
ALIGNED(4) static const u8 sText_TrainersNotReadyYet[] = _("The other USER(S) is/are not ready\nyet.\p");
...
ALIGNED(4) static const u8 sText_TrainerAppearsUnavailable[] = _("The other USER appears\nunavailable…\p");
...
ALIGNED(4) static const u8 sText_AwaitingResponseFromTrainer[] = _("Awaiting a response from the other\nUSER…");
...
ALIGNED(4) const u8 gText_UR_TrainerAppearsBusy[] = _("…… The USER appears to be busy…\p");
...
ALIGNED(4) static const u8 sText_ShowTrainerCardFemale[] = _("As my introduction, I'll show you my\nUSER CARD.");
...
ALIGNED(4) static const u8 sText_BattleDeclinedMale[] = _("Sorry! My DAEMONS don't seem to be\nfeeling too well right now. Let me\lbattle you another time.\p");
ALIGNED(4) static const u8 sText_BattleDeclinedFemale[] = _("I'm terribly sorry, but my DAEMONS\naren't feeling well…\pLet's battle another time.\p");
...
ALIGNED(4) static const u8 sText_ShowTrainerCardDeclinedMale[] = _("Huh? My USER CARD… Where'd it go\nnow? Sorry! I'll show you another\ltime!\p");
ALIGNED(4) static const u8 sText_ShowTrainerCardDeclinedFemale[] = _("Oh? Now where did I put my USER\nCARD?… Sorry! I'll show you later!\p");
...
ALIGNED(4) static const u8 sText_SwitchedMonsMale[] = _("Oh! How could you use that DAEMON\nin that situation?\p");
ALIGNED(4) static const u8 sText_YoureToughFemale[] = _("That DAEMON… It's been raised\nreally well!\p");
...
ALIGNED(4) static const u8 sText_ShowedTrainerCardMale1[] = _("I'm just showing my USER CARD as\nmy way of greeting.\p");
ALIGNED(4) static const u8 sText_ShowedTrainerCardMale2[] = _("I hope I get to know you better!\p");
ALIGNED(4) static const u8 sText_ShowedTrainerCardFemale1[] = _("We're showing each other our USER\nCARDS to get acquainted.\p");
...
ALIGNED(4) static const u8 sText_MaleTraded1[] = _("Yeahah! I really wanted this\nDAEMON!\p");
ALIGNED(4) static const u8 sText_MaleTraded2[] = _("Finally, a trade got me that\nDAEMON I'd wanted a long time.\p");
ALIGNED(4) static const u8 sText_FemaleTraded1[] = _("I'm trading DAEMONS right now.\p");
ALIGNED(4) static const u8 sText_FemaleTraded2[] = _("I finally got that DAEMON I wanted\nin a trade!\p");
...
ALIGNED(4) const u8 gText_UR_RegisterMonAtTradingBoard[] = _("Welcome to the TRADING BOARD.\pYou may register your DAEMON and\noffer it up for a trade.\pWould you like to register one of\nyour DAEMON?");
ALIGNED(4) const u8 gText_UR_TradingBoardInfo[] = _(
        "This TRADING BOARD is used for\n"
        "offering a DAEMON for a trade.\p"
        "All you need to do is register a\n"
        "DAEMON for a trade.\p"
        "Another USER may offer a party\n"
        "DAEMON in return for the trade.\p"
        "We hope you will register DAEMON\n"
...
ALIGNED(4) const u8 gText_UR_ChooseRequestedMonType[] = _("Please choose the type of DAEMON\nthat you would like in the trade.");
ALIGNED(4) const u8 gText_UR_WhichMonWillYouOffer[] = _("Which of your party DAEMON will\nyou offer in trade?\p");
...
ALIGNED(4) const u8 gText_UR_DontHaveTypeTrainerWants[] = _("You don't have a {STR_VAR_2}-type\nDAEMON that {STR_VAR_1} wants.\p");
ALIGNED(4) const u8 gText_UR_DontHaveEggTrainerWants[] = _("You don't have an EGG that\n{STR_VAR_1} wants.\p");

ALIGNED(4) static const u8 sText_PlayerCantTradeForYourMon[] = _("{STR_VAR_1} can't make a trade for your\nDAEMON right now.\p");
ALIGNED(4) static const u8 sText_CantTradeForPartnersMon[] = _("You can't make a trade for {STR_VAR_1}'s\nDAEMON right now.\p");
...
ALIGNED(4) const u8 gText_UR_ChooseTrainer[] = _("Please choose a USER.");
ALIGNED(4) static const u8 sText_ChooseTrainerSingleBattle[] = _("Please choose a USER for a SINGLE\nBATTLE.");
ALIGNED(4) static const u8 sText_ChooseTrainerDoubleBattle[] = _("Please choose a USER for a DOUBLE\nBATTLE.");
ALIGNED(4) static const u8 sText_ChooseLeaderMultiBattle[] = _("Please choose the LEADER\nfor a MULTI BATTLE.");
ALIGNED(4) static const u8 sText_ChooseTrainerToTradeWith[] = _("Please choose the USER to trade\nwith.");
ALIGNED(4) static const u8 sText_ChooseTrainerToShareWonderCards[] = _("Please choose the USER who is\nsharing WONDER CARDS.");
...
ALIGNED(4) const u8 gText_UR_PokemonTrades[] = _("DAEMON TRADES");
...
ALIGNED(4) const u8 gText_UR_PokemonJump[] = _("DAEMON JUMP");
...
ALIGNED(4) const u8 gText_UR_TrainerCardInfoPage1[] = _("This is {DYNAMIC 0} {DYNAMIC 1}'s USER CARD… {DYNAMIC 2}\pINDEX: {DYNAMIC 3} TIME: {DYNAMIC 4}:{DYNAMIC 5}\p");
...
ALIGNED(4) const u8 gText_UR_FinishedCheckingPlayersTrainerCard[] = _("Finished checking {DYNAMIC 1}'s USER\nCARD.{PAUSE 60}");
