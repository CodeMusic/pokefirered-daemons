...
const u8 gText_MenuPokemon[] = _("DAEMONS");
...
const u8 gText_Kanto[] = _("GAMUT");
const u8 gText_National[] = _("GLOBAL");
const u8 gText_PokemonHabitats[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}WHERE THEY RUN");
const u8 gText_DexCategory_GrasslandPkmn[] = _("Userland DAEMON");
const u8 gText_DexCategory_ForestPkmn[] = _("Branching DAEMON");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("Boundary DAEMON");
const u8 gText_DexCategory_SeaPkmn[] = _("Stream DAEMON");
const u8 gText_DexCategory_CavePkmn[] = _("Kernel DAEMON");
const u8 gText_DexCategory_MountainPkmn[] = _("Stack DAEMON");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("Fragmented DAEMON");
const u8 gText_DexCategory_UrbanPkmn[] = _("Network DAEMON");
const u8 gText_DexCategory_RarePkmn[] = _("Unindexed DAEMON");
...
const u8 gText_ClosePokedex[] = _("CLOSE INDEX");
...
const u8 gText_PokemonList[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}THE INDEX");
const u8 gText_NumericalModeKanto[] = _("NUMERICAL MODE: GAMUT");
const u8 gText_NumericalModeNational[] = _("NUMERICAL MODE: GLOBAL");
const u8 gText_PokemonListNoColor[] = _("DAEMON LIST");
...
const u8 gText_PokedexPokemon[] = _(" DAEMON");
...
const u8 gSaveStatName_Badges[] = _("MARKS");
const u8 gSaveStatName_Pokedex[] = _("INDEX");
...
const u8 gText_DbgMenuDoldrum[] = _("DOLDRUM");
const u8 gText_DbgMenuArtsai[] = _("ARTSAI");
const u8 gText_DbgMenuCrystal[] = _("CRYSTAL");
const u8 gText_DbgMenuWarden[] = _("WARDEN");
const u8 gText_DbgMenuJump[] = _("JUMP");
const u8 gText_DbgMenuSong[] = _("SONG {STR_VAR_1}");
const u8 gText_DbgMenuSfx[] = _("SFX {STR_VAR_2}");
const u8 gText_DbgMenuWatch[] = _("TIME {STR_VAR_3}");
const u8 gText_DbgSun[] = _("SUN");
const u8 gText_DbgMon[] = _("MON");
const u8 gText_DbgTue[] = _("TUE");
const u8 gText_DbgWed[] = _("WED");
const u8 gText_DbgThu[] = _("THU");
const u8 gText_DbgFri[] = _("FRI");
const u8 gText_DbgSat[] = _("SAT");
...
const u8 gText_OakForbidsUseOfItemHere[] = _("CRYSTAL: {PLAYER}! This isn't the\ntime to use that!{PAUSE_UNTIL_PRESS}");
const u8 gText_CantDismountBike[] = _("You can't dismount your BIKE here.{PAUSE_UNTIL_PRESS}");
const u8 gText_ItemfinderResponding[] = _("Huh? The GREP's responding!\pThere's an item buried\naround here!{PAUSE_UNTIL_PRESS}");
const u8 gText_ItemfinderShakingWildly[] = _("Oh! The GREP's shaking wildly!\pThere's an item buried\nunderfoot!\p‥ ‥ ‥ ‥ ‥ ‥{PAUSE_UNTIL_PRESS}");
...
const u8 gText_RepelEffectsLingered[] = _("But an earlier SUPPRESS is\nstill holding.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the {STR_VAR_2}.\pWild DAEMON will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the {STR_VAR_2}.\pWild DAEMON will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PlayedPokeFluteCatchy[] = _("Played the INTERRUPT.\pNow, that's a catchy tune!{PAUSE_UNTIL_PRESS}");
const u8 gText_PlayedPokeFlute[] = _("Played the INTERRUPT.");
const u8 gText_PokeFluteAwakenedMon[] = _("The INTERRUPT resumed a\nsuspended DAEMON.{PAUSE_UNTIL_PRESS}");
const u8 gText_TMCase[] = _("TOOLKIT");
const u8 gText_Close[] = _("CLOSE");
const u8 gText_TMCaseWillBePutAway[] = _("The TOOLKIT\nwill be put away.");
const u8 gText_FontSmall[] = _("{FONT_SMALL}");
const u8 gText_FontNormal[] = _("{FONT_NORMAL}");
const u8 gText_EmptySpace[] = _("  ");
const u8 gText_BerryPouch[] = _("TRAP TABLE");
const u8 gText_TheBerryPouchWillBePutAway[] = _("The TRAP TABLE will be\nput away.");
...
const u8 gText_CantBeUsedOnPkmn[] = _("This can't be used on that DAEMON.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CantSwitchWithAlly[] = _("You can't switch {STR_VAR_1}'s DAEMON\nwith one of yours!{PAUSE_UNTIL_PRESS}");
const u8 gText_EggCantBattle[] = _("An EGG can't battle!{PAUSE_UNTIL_PRESS}");
const u8 gText_CantUseUntilNewBadge[] = _("This can't be used until a new MARK\nis obtained.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanThreeMayEnter[] = _("No more than three DAEMONS may\nenter.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanTwoMayEnter[] = _("No more than two DAEMONS may\nenter.{PAUSE_UNTIL_PRESS}");
const u8 gText_SendMailToPC[] = _("Send the removed\nMAIL to your PORT?");
const u8 gText_MailSentToPC[] = _("The MAIL was sent to your PORT.{PAUSE_UNTIL_PRESS}");
const u8 gText_PCMailboxFull[] = _("Your PORT's MAILBOX is full.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MailTakenFromPkmn[] = _("MAIL was taken from the DAEMON.{PAUSE_UNTIL_PRESS}");
const u8 gText_SwitchedPkmnItem[] = _("The {STR_VAR_2} was taken and\nreplaced with the {STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnHoldingItemCantHoldMail[] = _("This DAEMON is holding an item. It\ncannot hold MAIL.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailTransferredFromMailbox[] = _("MAIL was transferred from\nthe MAILBOX.{PAUSE_UNTIL_PRESS}");
const u8 gText_BagFullCouldNotRemoveItem[] = _("The {STR_VAR_1} is full. The DAEMON's\nitem could not be removed.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnBecameHealthy[] = _("{STR_VAR_1} is clear.{PAUSE_UNTIL_PRESS}");
const u8 gText_MovesPPIncreased[] = _("{STR_VAR_1}'s MP increased.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnElevatedToLvVar2[] = _("{STR_VAR_1} was elevated to\nLv. {STR_VAR_2}.");
const u8 gText_PkmnBaseVar2StatIncreased[] = _("{STR_VAR_1}'s base {STR_VAR_2}\nstat was raised.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnSnappedOutOfConfusion[] = _("{STR_VAR_1} snapped out of its\nthrashing.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnGotOverInfatuation[] = _("{STR_VAR_1} is no longer\nPAIRED.{PAUSE_UNTIL_PRESS}");
const u8 gText_OnlyPkmnForBattle[] = _("That's your only DAEMON for battle.");
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That DAEMON can't be traded now.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other USER's DAEMON can't be\ntraded now.");
ALIGNED(4) const u8 gText_OtherTrainerCantAcceptPkmn[] = _("The other USER can't accept that\nDAEMON now.");
ALIGNED(4) const u8 gText_CantTradeWithTrainer[] = _("You can't trade with that USER now.");
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of DAEMON that\nthe other USER wants.");
ALIGNED(4) const u8 gText_ThatIsntAnEgg[] = _("That isn't an EGG.");
const u8 gText_ChoosePokemon[] = _("Choose a DAEMON.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which DAEMON?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which DAEMON?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which DAEMON?");
const u8 gText_DoWhatWithPokemon[] = _("Do what with this DAEMON?");
const u8 gText_NothingToCut[] = _("There is nothing to PRUNE.");
const u8 gText_CantSurfHere[] = _("You cannot TRAVERSE here.");
const u8 gText_AlreadySurfing[] = _("You are already traversing.");
const u8 gText_CantUseHere[] = _("Can't use that here.");
const u8 gText_RestoreWhichMove[] = _("Restore which ROUTINE?");
const u8 gText_BoostPp[] = _("Boost MP of which?");
const u8 gText_DoWhatWithItem[] = _("Do what with an item?");
const u8 gText_NoPokemonForBattle[] = _("No battling this way!");
const u8 gText_ChoosePokemon2[] = _("Choose a DAEMON.");
const u8 gText_NotEnoughHp[] = _("Not enough HP‥");
const u8 gText_ThreePkmnAreNeeded[] = _("Three DAEMONS are needed.");
const u8 gText_PokemonCantBeSame[] = _("DAEMON can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose DAEMON or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose DAEMON and confirm.");
const u8 gText_TwoPokemonAreNeeded[] = _("Two DAEMONS are needed.");
...
const u8 gText_OakImportantToGetToKnowPokemonThroughly[] = _("CRYSTAL: It's important to get to\nknow your DAEMON thoroughly.\p");
const u8 gText_OakThisIsListOfPokemon[] = _("This is a list of your DAEMON,\n{PLAYER}.\pOpen this to check the skills and\nmoves of your DAEMON.\pYou also choose DAEMON here if\nyou want to use an item on one.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_LureWildPokemon[] = _("Lure wild DAEMON.");
...
const u8 gText_PkmnCantParticipate[] = _("That DAEMON can't participate.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_StoreItemsInThePC[] = _("Store items in the PORT.");
...
const u8 gText_LtSurge[] = _("GAUGE");
const u8 gText_Koga[] = _("TILT");
...
const u8 gText_Tm13_4000Coins[] = _("PLUGIN13{CLEAR_TO 0x48}{FONT_SMALL}4,000 COINS");
const u8 gText_Tm23_3500Coins[] = _("PLUGIN23{CLEAR_TO 0x48}{FONT_SMALL}3,500 COINS");
const u8 gText_Tm24_4000Coins[] = _("PLUGIN24{CLEAR_TO 0x48}{FONT_SMALL}4,000 COINS");
const u8 gText_Tm30_4500Coins[] = _("PLUGIN30{CLEAR_TO 0x48}{FONT_SMALL}4,500 COINS");
const u8 gText_Tm35_4000Coins[] = _("PLUGIN35{CLEAR_TO 0x48}{FONT_SMALL}4,000 COINS");
...
const u8 gText_Beauty[] = _("STYLIST");
...
const u8 gText_Beauty_2[] = _("STYLIST");
...
const u8 gText_PokeBalls[] = _("BOXES");
const u8 gText_TMsAndHMs[] = _("TOOLKIT");
const u8 gText_Berries[] = _("TRAPS");
const u8 gText_Boulderbadge[] = _("SLATE MARK");
const u8 gText_Cascadebadge[] = _("SLOPE MARK");
const u8 gText_Thunderbadge[] = _("SENSE MARK");
const u8 gText_Rainbowbadge[] = _("FIT MARK");
const u8 gText_Soulbadge[] = _("SKEW MARK");
const u8 gText_Marshbadge[] = _("FRAME MARK");
const u8 gText_Volcanobadge[] = _("HEAT MARK");
const u8 gText_Earthbadge[] = _("TRUE MARK");
const u8 gText_SomeoneSPc[] = _("SOMEONE'S PORT");
const u8 gText_BillSPc[] = _("HOLT'S PORT");
const u8 gText_SPc[] = _("{PLAYER}'s PORT");
const u8 gText_HallOfFame_2[] = _("HALL OF FAME");
const u8 gText_LogOff[] = _("LOG OFF");
const u8 gText_ProfOakSPc[] = _("CRYSTAL CLEAR's PORT");
const u8 gText_Eevee[] = _("MUSAI");
const u8 gText_Flareon[] = _("CODEMUSAI");
const u8 gText_Jolteon[] = _("SEEKMUSAI");
const u8 gText_Vaporeon[] = _("CAREMUSAI");
...
const u8 gText_Abra_180Coins[] = _("HUNCH{CLEAR_TO 0x55}{FONT_SMALL} 180 COINS");
const u8 gText_Clefairy_500Coins[] = _("ANOMALY{CLEAR_TO 0x55}{FONT_SMALL} 500 COINS");
const u8 gText_Dratini_2800Coins[] = _("CANARY{CLEAR_TO 0x4B}{FONT_SMALL} 2,800 COINS");
const u8 gText_Scyther_5500Coins[] = _("REAPER{CLEAR_TO 0x4B}{FONT_SMALL} 5,500 COINS");
const u8 gText_Porygon_9999Coins[] = _("SUBSTRATE{CLEAR_TO 0x4B}{FONT_SMALL} 9,999 COINS");
const u8 gText_Abra_120Coins[] = _("HUNCH{CLEAR_TO 0x55}{FONT_SMALL} 120 COINS");
const u8 gText_Clefairy_750Coins[] = _("ANOMALY{CLEAR_TO 0x55}{FONT_SMALL} 750 COINS");
const u8 gText_Pinsir_2500Coins[] = _("BLOCKING{CLEAR_TO 0x4B}{FONT_SMALL} 2,500 COINS");
const u8 gText_Dratini_4600Coins[] = _("CANARY{CLEAR_TO 0x4B}{FONT_SMALL} 4,600 COINS");
const u8 gText_Porygon_6500Coins[] = _("SUBSTRATE{CLEAR_TO 0x4B}{FONT_SMALL} 6,500 COINS");
const u8 gText_NoThanks_2[] = _("NO THANKS");
const u8 gText_HelixFossil[] = _("HELIX CORE");
const u8 gText_DomeFossil[] = _("DRUM CORE");
const u8 gText_OldAmber[] = _("OLD CORE");
...
const u8 gText_PokeBallsPocket[] = _("BOXES POCKET");
const u8 gText_TmCase[] = _("TOOLKIT");
const u8 gText_BerryPouch_2[] = _("TRAP TABLE");
...
const u8 gText_Vermilion[] = _("ARDOR");
...
const u8 gText_PokemonJump[] = _("DAEMON JUMP");
const u8 gText_DodrioBerryPicking[] = _("TRIPLECORE BERRY-PICKING");
const u8 gText_2Tinymushrooms[] = _("2 TINYMUSHROOMS");
const u8 gText_1BigMushroom[] = _("1 BIG MUSHROOM");
const u8 gText_SeviiIslands[] = _("THE MARGINS");
const u8 gText_NavelRock[] = _("NAVEL ROCK");
const u8 gText_BirthIsland[] = _("THE ANNEX");
const u8 gText_MiracleSeed_1000Coins[] = _("GROWTH GAIN{CLEAR_TO 0x50}{FONT_SMALL}1,000 COINS");
const u8 gText_Charcoal_1000Coins[] = _("ENTROPY GAIN{CLEAR_TO 0x50}{FONT_SMALL}1,000 COINS");
const u8 gText_MysticWater_1000Coins[] = _("FLOW GAIN{CLEAR_TO 0x50}{FONT_SMALL}1,000 COINS");
const u8 gText_YellowFlute_1600Coins[] = _("CALM TONE{CLEAR_TO 0x50}{FONT_SMALL}1,600 COINS");
const u8 gText_SmokeBall_800Coins[] = _("ESCAPE HATCH{CLEAR_TO 0x5A}{FONT_SMALL}800 COINS");
...
const u8 gText_Energypowder_50[] = _("FIELD PATCH{CLEAR_TO 0x74}{FONT_SMALL}50");
const u8 gText_EnergyRoot_80[] = _("WORKAROUND{CLEAR_TO 0x74}{FONT_SMALL}80");
const u8 gText_HealPowder_50[] = _("HOTFIX{CLEAR_TO 0x74}{FONT_SMALL}50");
const u8 gText_RevivalHerb_300[] = _("COLD START{CLEAR_TO 0x6F}{FONT_SMALL}300");
const u8 gText_Protein_1000[] = _("WATTAGE{CLEAR_TO 0x65}{FONT_SMALL}1,000");
const u8 gText_Iron_1000[] = _("SHIELDING{CLEAR_TO 0x65}{FONT_SMALL}1,000");
const u8 gText_Carbos_1000[] = _("CLOCK RATE{CLEAR_TO 0x65}{FONT_SMALL}1,000");
const u8 gText_Calcium_1000[] = _("BANDWIDTH{CLEAR_TO 0x65}{FONT_SMALL}1,000");
const u8 gText_Zinc_1000[] = _("INSULATION{CLEAR_TO 0x65}{FONT_SMALL}1,000");
const u8 gText_HpUp_1000[] = _("MEMORY{CLEAR_TO 0x65}{FONT_SMALL}1,000");
const u8 gText_PpUp_3000[] = _("MP UP{CLEAR_TO 0x65}{FONT_SMALL}3,000");
...
const u8 gFameCheckerText_FameCheckerWillBeClosed[] = _("The HEARSAY will be closed.");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this DAEMON?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0x00} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0x00}!");
const u8 gText_MarkYourPkmn[] = _("Mark your DAEMON.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last DAEMON!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a DAEMON!");
...
const u8 gPCText_Pokecenter[] = _("CHECKPOINT");
const u8 gPCText_Machine[] = _("TILES");
const u8 gPCText_Simple[] = _("SIMPLE");
const u8 gText_PC_WhatWouldYouLikeToDo[] = _("なにを しますか?");
const u8 gText_WithdrawPokemon[] = _("WITHDRAW DAEMON");
const u8 gText_DepositPokemon[] = _("DEPOSIT DAEMON");
const u8 gText_MovePokemon[] = _("MOVE DAEMON");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("You can withdraw a DAEMON if you\nhave any in a BOX.");
const u8 gText_DepositMonDescription[] = _("You can deposit your party DAEMON\nin any BOX.");
const u8 gText_MoveMonDescription[] = _("You can move DAEMON that are\nstored in any BOX.");
const u8 gText_MoveItemsDescription[] = _("You can move items held by any\nDAEMON in a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("See you later!");
const u8 gText_JustOnePkmn[] = _("Can't deposit the last DAEMON!");
const u8 gText_PartyFull[] = _("Can't take any more DAEMONS.");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the DAEMON MAIL?");
...
const u8 gText_PokemonCenter[] = _("CHECKPOINT");
...
//  DRAFT (T-269, 2026-09-25): the day banner on leaving a building -- the day's note, the weekday, the watch.
//  Awaiting the user's approval.
const u8 gText_DayNoteC[] = _("C");
const u8 gText_DayNoteD[] = _("D");
const u8 gText_DayNoteE[] = _("E");
const u8 gText_DayNoteF[] = _("F");
const u8 gText_DayNoteG[] = _("G");
const u8 gText_DayNoteA[] = _("A");
const u8 gText_DayNoteB[] = _("B");
const u8 gText_DayBannerDot[] = _(" · ");
const u8 gText_DaySunday[] = _("SUNDAY");
const u8 gText_DayMonday[] = _("MONDAY");
const u8 gText_DayTuesday[] = _("TUESDAY");
const u8 gText_DayWednesday[] = _("WEDNESDAY");
const u8 gText_DayThursday[] = _("THURSDAY");
const u8 gText_DayFriday[] = _("FRIDAY");
const u8 gText_DaySaturday[] = _("SATURDAY");
const u8 gText_WatchDay[] = _("DAY");
const u8 gText_WatchDusk[] = _("DUSK");
const u8 gText_WatchNight[] = _("NIGHT");
const u8 gText_WatchDawn[] = _("DAWN");
...
const u8 gText_RegionMap_AreaDesc_ViridianForest[] = _("A deep and sprawling forest that\nextends around CALLOW CITY. A\lnatural maze, many people become\llost inside.");
const u8 gText_RegionMap_AreaDesc_MtMoon[] = _("A mystical mountain that is known\nfor its frequent meteor falls.\lThe shards of stars that fall\lhere are known as REFLECTIONS.");
const u8 gText_RegionMap_AreaDesc_DiglettsCave[] = _("A seemingly plain tunnel\nthat was dug by wild\lTAPPOINT. It is famous for\lconnecting ROUTES 2 and 11.");
const u8 gText_RegionMap_AreaDesc_VictoryRoad[] = _("A tunnel situated on ROUTE 23. It\nearned its name because it must be\ltraveled by all USERS aiming for\lthe top.");
const u8 gText_RegionMap_AreaDesc_PokemonMansion[] = _("A decrepit, burned-down mansion on\nQUICKSILVER ISLAND. It got its\lname because a famous DAEMON\lresearcher lived there.");
const u8 gText_RegionMap_AreaDesc_SafariZone[] = _("An amusement park outside LURID\nCITY where many rare DAEMON can\lbe observed in the wild. Bind them\lin a popular game!");
...
const u8 gText_RegionMap_AreaDesc_PokemonTower[] = _("A tower that houses the graves of\ncountless DAEMON. Many people visit\lit daily to pay their respects to\lthe fallen.");
const u8 gText_RegionMap_AreaDesc_CeruleanCave[] = _("A mysterious cave that is filled\nwith terribly tough DAEMON. It is\lso dangerous, the DAEMON LEAGUE is\lin charge of it.");
const u8 gText_RegionMap_AreaDesc_PowerPlant[] = _("A power plant that was abandoned\nyears ago, though some of the\lmachines still work. It is infested\lwith electric DAEMON.");
...
const u8 gText_RegionMap_AreaDesc_TanobyRuins[] = _("An ancient ruin that is rumored to\nbe home to a peculiar DAEMON.\lHowever, so far, the DAEMON\lremains an unconfirmed rumor.");
...
const u8 gText_PokeSum_EggOrigin_DayCare[] = _("An odd DAEMON EGG found by the\nDAY-CARE couple.");
const u8 gText_PokeSum_EggOrigin_TravelingMan[] = _("An odd DAEMON EGG obtained from\nthe traveling man.");
const u8 gText_PokeSum_EggOrigin_NicePlace[] = _("A wondrously peculiar DAEMON EGG\nobtained at a nice place.");
const u8 gText_PokeSum_EggOrigin_Spa[] = _("An odd DAEMON EGG obtained from an\nold woman at the SPA.");
const u8 gText_PokeSum_EggOrigin_Trade[] = _("A peculiar DAEMON EGG obtained in\na trade.");
...
const u8 gText_PokeSum_PageName_PokemonInfo[] = _("DAEMON INFO");
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("DAEMON SKILLS");
const u8 gText_PokeSum_PageName_KnownMoves[] = _("KNOWN ROUTINES");
...
const u8 gText_PokeSum_HmMovesCantBeForgotten[] = _("DRIVER ROUTINES can't be\nforgotten now.");
...
const u8 gText_Var1sTrainerCard[] = _("'s USER CARD");
...
const u8 gText_PokemonTrades[] = _("DAEMON TRADES");
const u8 gText_UnionRoomTradesBattles[] = _("UNION TRADES & BATTLES");
const u8 gText_BerryCrushes[] = _("BERRY CRUSH");
const u8 gText_WaitingTrainerFinishReading[] = _("Waiting for the other USER to\nfinish reading your USER CARD.");
...
const u8 gStartMenuDesc_Pokedex[] = _("A device that records DAEMON\nsecrets upon meeting or binding\lthem.");
const u8 gStartMenuDesc_Pokemon[] = _("Check and organize DAEMON that are\ntraveling with you in your party.");
...
const u8 gText_Pokemon2[] = _("DAEMON");
...
const u8 gText_PlayerScurriedToCenter[] = _("{PLAYER} scurried to a DAEMON\nCENTER, protecting the exhausted\land HALTED DAEMON from further\lharm‥\p");
const u8 gText_PlayerScurriedBackHome[] = _("{PLAYER} scurried back home,\nprotecting the exhausted and\lHALTED DAEMON from further harm‥\p");
const u8 gText_Diploma_Player[] = _("PLAYER: {DYNAMIC 0x00}");
const u8 gText_Diploma_ThisDocument[] = _("This document is issued in\nrecognition of your magnificent\lachievement - the completion of\lthe {DYNAMIC 0x01} INDEX.");
const u8 gText_Diploma_GameFreak[] = _("GAME FREAK");
const u8 gText_Diploma_National[] = _("GLOBAL");
const u8 gText_Diploma_Kanto[] = _("GAMUT");
...
const u8 gText_Pokedex[] = _("INDEX");
const u8 gTextJPDummy_Hiki[] = _("");
const u8 gText_Badges[] = _("MARKS");
...
const u8 gText_PkmnJumpRecords[] = _("DAEMON JUMP RECORDS");
...
const u8 gText_BerryPickingRecords[] = _("TRIPLECORE BERRY-PICKING RECORDS");
...
ALIGNED(4) const u8 gText_Ghost[] = _("REMNANT");   // T-253
const u8 gText_PokemonOnHook[] = _("A DAEMON's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("DAEMON");
const u8 gEasyChatGroupName_Trainer[] = _("USER");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("DAEMON2");
...
const u8 gTradeText_ChooseAPokemon[] = _("Choose a DAEMON.");
...
const u8 gText_Trade_OnlyPkmnForBattle[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}That's your only DAEMON for battle.");
const u8 gText_WaitingForFriendToFinish[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Waiting for your friend\nto finish…");
const u8 gText_FriendWantsToTrade[] = _("Your friend wants to trade\nDAEMONS.");
...
const u8 gText_WhichMoveShouldBeForgotten[] = _("Which ROUTINE should be forgotten?\p");
...
const u8 gFameCheckerOakName[] = _("CRYSTAL CLEAR");
const u8 gFameCheckerDaisyName[] = _("VERA");
const u8 gFameCheckerBillName[] = _("HOLT");
...
const u8 gText_NewTrainerReceived[] = _("A new USER has arrived.");
...
const u8 gText_CantAcceptNewsFromTrainer[] = _("You can't accept WONDER NEWS from\nthis USER.");
...
const u8 gText_OtherTrainerHasCard[] = _("The other USER has the same\nWONDER CARD already.");
const u8 gText_OtherTrainerHasNews[] = _("The other USER has the same\nWONDER NEWS already.");
const u8 gText_OtherTrainerHasStamp[] = _("The other USER has the same STAMP\nalready.");
const u8 gText_OtherTrainerCanceled[] = _("The other USER canceled\ncommunication.");
