...
const u8 gText_OakForbidsUseOfItemHere[] = _("CRYSTAL: {PLAYER}. Not now.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_OakImportantToGetToKnowPokemonThroughly[] = _("CRYSTAL: Read what it can do. Then\nread it again.\p");
const u8 gText_OakThisIsListOfPokemon[] = _("These are your DAEMONS, {PLAYER}.\pOpen one to see what it runs and\nwhat it knows.\pChoose one here, too, when an item\nis for one of them.{PAUSE_UNTIL_PRESS}");
