...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_OWL / 2]                     = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_STAFF_SLATE
    [OBJ_EVENT_GFX_STAFF_DOLDRUM_SWIMMER / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_FEMALE),
    [OBJ_EVENT_GFX_STAFF_ARDOR / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_FEMALE),
    [OBJ_EVENT_GFX_STAFF_LURID / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE),
    [OBJ_EVENT_GFX_STAFF_QUICKSILVER / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE),
    [OBJ_EVENT_GFX_BENCHMARK_GUIDE / 2] = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_CALLOW_ADULT / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    //  T-256: the table is read at [graphicsId / 2] and is unsized, so DAD's entry is what makes it reach him.
    [OBJ_EVENT_GFX_DAD / 2]              = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_SLATE_CHILD / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_SLATE_ELDER / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_DOLDRUM_ADULT / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_ARDOR_CHILD / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_ARDOR_ELDER / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_HALFTONE_ADULT / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_VERDIGRIS_ADULT / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_LURID_CHILD / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_LURID_ELDER / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_BRAZEN_ADULT / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_QUICKSILVER_ADULT / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TOWN_UMBRA_ADULT / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_BURGLAR / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_POKEMON_BREEDER / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_BIRD_KEEPER / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_PAINTER / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_AROMA_LADY / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_POKEMON_RANGER_M / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_LADY / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_TAMER / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
    [OBJ_EVENT_GFX_CUE_BALL / 2] = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL),
};
