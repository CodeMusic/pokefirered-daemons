...
const u8 gMoveDescription_WingAttack[] = _("The foe is\nstruck with large,\nimposing wings\nspread wide.");
...
const u8 gMoveDescription_VineWhip[] = _("The foe is\nstruck with\nslender, whip- like\nvines.");
...
const u8 gMoveDescription_PowderSnow[] = _("Blasts the foe\nwith a snowy gust.\nIt may cause\nfreezing.");
...
const u8 gMoveDescription_MagicalLeaf[] = _("The foe is\nattacked with a\nstrange leaf that\ncannot be evaded.");
