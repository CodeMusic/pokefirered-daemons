...
const u8 gMoveDescription_Headbutt[] = _("Two things arrive\nat once. It may\nleave the foe\nunable to act.");
...
const u8 gMoveDescription_RockSlide[] = _("Brings down what\nwas held up above.\nIt may leave the\nfoe unable to act.");
...
const u8 gMoveDescription_Spite[] = _("Cuts 2 to 5\nMP from the\nroutine the\nfoe last ran.");
...
const u8 gMoveDescription_Octazooka[] = _("More at once\nthan the foe can\ntake in. Lowers\naccuracy.");
...
const u8 gMoveDescription_Pursuit[] = _("A routine that\nworks especially\nwell on a foe that\nis switching out.");
...
const u8 gMoveDescription_FakeOut[] = _("Goes first and\nholds the foe\nup. Only on the\nturn it arrives.");
...
const u8 gMoveDescription_FeatherDance[] = _("Fills the air\naround the\nfoe. Sharply\nlowers ATTACK.");
...
const u8 gMoveDescription_ShadowPunch[] = _("Reaches the foe\nfrom where it is\nnot. It cannot\nbe evaded.");
const u8 gMoveDescription_Extrasensory[] = _("The user attacks\nwith an odd power\nthat may make the\nfoe flinch.");
const u8 gMoveDescription_SkyUppercut[] = _("Drops the\nparticulars and\nhits the shape.\nReaches anything.");
const u8 gMoveDescription_SandTomb[] = _("Covers the foe\nover and holds\nit there for two\nto five turns.");
