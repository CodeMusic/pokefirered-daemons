...
const u8 gMoveDescription_SwordsDance[] = _("The user cycles hard\nbefore it does\nanything. Sharply\nraises ATTACK.");
...
const u8 gMoveDescription_FuryAttack[] = _("The foe is\njabbed repeatedly\nwith a horn or beak\ntwo to five times.");
const u8 gMoveDescription_HornDrill[] = _("Removes the record\nentirely. It only\nlands once.");
const u8 gMoveDescription_Tackle[] = _("Puts its own data\nwhere the foe's\ndata was.");
const u8 gMoveDescription_BodySlam[] = _("Writes a whole\nblock at once.\nMay leave the\nfoe THROTTLED.");
const u8 gMoveDescription_Wrap[] = _("Closes around the\nfoe and holds it\nthere for two to\nfive turns.");
...
const u8 gMoveDescription_TailWhip[] = _("Leaves the foe\nopen where it\nwas not. Lowers\nDEFENSE.");
...
const u8 gMoveDescription_Bite[] = _("Shuts the\nlight out.\nThe foe\nmay flinch.");
const u8 gMoveDescription_Growl[] = _("Runs the foe below\nits rated capacity.\nLowers ATTACK.");
...
const u8 gMoveDescription_Ember[] = _("The foe is\nattacked with small\nflames. The foe\nmay overheat.");
const u8 gMoveDescription_Flamethrower[] = _("The foe is scorched\nwith intense flames.\nThe foe may\noverheat.");
const u8 gMoveDescription_Mist[] = _("Nothing may write to\nthe party's stats\nfor as long as\nit holds.");
...
const u8 gMoveDescription_LeechSeed[] = _("Seeded on the\nfoe. It gives\nup a little\nevery turn.");
const u8 gMoveDescription_Growth[] = _("Scaling up gives\none instance more,\nnot more instances.\nRaises SP. ATK.");
const u8 gMoveDescription_RazorLeaf[] = _("Splits it clean\nalong the grain.\nHigh critical-hit\nratio.");
const u8 gMoveDescription_SolarBeam[] = _("Gathers on the first\nturn, then runs it\nall at once on\nthe second.");
...
const u8 gMoveDescription_StringShot[] = _("The foe's work\npiles up\nbehind it.\nLowers SPEED.");
...
const u8 gMoveDescription_Fissure[] = _("The foe is\ndropped into a\nfissure. The foe\nHALTS if it hits.");
const u8 gMoveDescription_Dig[] = _("Goes under, and is\nup again next turn.\nOutside, it leaves\na cave the same way.");
const u8 gMoveDescription_Toxic[] = _("Leaves the foe\nCASCADING, and the\nloss grows with\nevery turn.");
const u8 gMoveDescription_Confusion[] = _("A weak telekinetic\nattack that may\nalso leave the\nfoe thrashing.");
const u8 gMoveDescription_Psychic[] = _("Reads the foe its\nown way. It may\nlower the foe's\nSP. DEF.");
...
const u8 gMoveDescription_NightShade[] = _("Costs the foe what\nthe user's level is\nworth, and nothing\nelse.");
const u8 gMoveDescription_Mimic[] = _("The user copies the\nroutine last run by\nthe foe, for the\nrest of the battle.");
const u8 gMoveDescription_Screech[] = _("Strips the foe of\nwhat was guarding\nit. Sharply cuts\nDEFENSE.");
const u8 gMoveDescription_DoubleTeam[] = _("More than one of it\nis running at once.\nRaises evasiveness.");
const u8 gMoveDescription_Recover[] = _("Loads the last good\nstate: up to half\nof the user's\nmaximum HP.");
const u8 gMoveDescription_Harden[] = _("Pinned in place,\nso nothing can\nshift it. Raises\nDEFENSE.");
const u8 gMoveDescription_Minimize[] = _("Takes up less room,\nso less of it can\nbe hit. Raises\nevasiveness.");
const u8 gMoveDescription_Smokescreen[] = _("Blurs what the foe\nis aiming at.\nReduces accuracy.");
const u8 gMoveDescription_ConfuseRay[] = _("The foe is\nexposed to a\nsinister ray that\ntriggers thrashing.");
const u8 gMoveDescription_Withdraw[] = _("Finds the still\npocket in the\ncurrent. Raises\nDEFENSE.");
const u8 gMoveDescription_DefenseCurl[] = _("Packs itself\nsmaller, so\nless of it can\nbe reached.");
const u8 gMoveDescription_Barrier[] = _("Puts something round\nitself that holds.\nSharply raises\nDEFENSE.");
...
const u8 gMoveDescription_FurySwipes[] = _("The foe is\nraked with sharp\nclaws or scythes\ntwo to five times.");
...
const u8 gMoveDescription_HyperFang[] = _("The foe is\nattacked with sharp\nfangs. It may make\nthe foe flinch.");
const u8 gMoveDescription_Sharpen[] = _("Folded in\nwhere it is\nused. Raises\nATTACK.");
const u8 gMoveDescription_Conversion[] = _("The user changes its\ntype to match the\ntype of one of its\nroutines.");
const u8 gMoveDescription_TriAttack[] = _("Three at once,\nand any one of\nthem may leave\na state behind.");
const u8 gMoveDescription_SuperFang[] = _("Cuts the foe\ndown to half\nof what it\nhad.");
...
const u8 gMoveDescription_Nightmare[] = _("A SUSPENDED\nfoe gets nothing\nat all. It loses\nHP each turn.");
...
const u8 gMoveDescription_CottonSpore[] = _("Fills the foe's path\nwith what it cannot\nclear. Sharply\nlowers SPEED.");
...
const u8 gMoveDescription_ScaryFace[] = _("Lowers the foe's\npriority, so it is\nscheduled later.");
...
const u8 gMoveDescription_MudSlap[] = _("Covers what the foe\nreads from. Damages\nit, and lowers its\naccuracy.");
const u8 gMoveDescription_Octazooka[] = _("More at once than\nthe foe can take in.\nLowers accuracy.");
const u8 gMoveDescription_Spikes[] = _("Left where the foe\nmust come in. Hurts\nwhatever arrives.");
...
const u8 gMoveDescription_Detect[] = _("The check holds and\nnothing gets past.\nIt may fail if it\nis run again.");
...
const u8 gMoveDescription_Charm[] = _("Cuts the foe's clock\nhard. Sharply\nreduces ATTACK.");
const u8 gMoveDescription_Rollout[] = _("Comes round for five\nturns, heavier on\nevery pass.");
...
const u8 gMoveDescription_MeanLook[] = _("Holds the\nconnection\nopen. The foe\ncannot leave.");
const u8 gMoveDescription_Attract[] = _("Binds the foe's\nattention to the\nuser, which may\nleave it unable to act.");
const u8 gMoveDescription_SleepTalk[] = _("While SUSPENDED, the\nuser runs one of\nits own routines at\nrandom.");
...
const u8 gMoveDescription_Encore[] = _("The foe is held to\nthe routine it last\nran, for two to\nsix turns.");
const u8 gMoveDescription_Pursuit[] = _("A routine that works\nespecially well on a\nfoe that is\nswitching out.");
...
const u8 gMoveDescription_FutureSight[] = _("Set now, it runs two\nturns later, whatever\nhappens between.");
...
const u8 gMoveDescription_MagicCoat[] = _("Reflects back\nthe foe's SEED\nand any status-\ndamaging move.");
...
const u8 gMoveDescription_Yawn[] = _("Puts the foe on\nthe queue to be\nSUSPENDED one\nturn from now.");
...
const u8 gMoveDescription_Imprison[] = _("Prevents foe from\nusing any move\nthat is also known\nby the user.");
...
const u8 gMoveDescription_Snatch[] = _("Takes the foe's\nrepair or state\nchange for itself\ninstead.");
...
const u8 gMoveDescription_Tickle[] = _("The foe is made\nto laugh, reducing\nits ATTACK and\nDEFENSE stats.");
const u8 gMoveDescription_CosmicPower[] = _("Widens the frame until\nlittle of it matters.\nRaises DEFENSE and\nSP. DEF.");
const u8 gMoveDescription_WaterSpout[] = _("The higher the\nuser's HP, the more\npowerful this\nattack becomes.");
const u8 gMoveDescription_SignalBeam[] = _("The foe is hit\nwith a flashing\nbeam that may also\ncause thrashing.");
const u8 gMoveDescription_ShadowPunch[] = _("Reaches the foe from\nwhere it is not.\nIt cannot be\nevaded.");
const u8 gMoveDescription_Extrasensory[] = _("The user attacks\nwith an odd power\nthat may make the\nfoe flinch.");
const u8 gMoveDescription_SkyUppercut[] = _("Drops the\nparticulars and\nhits the shape.\nReaches anything.");
const u8 gMoveDescription_SandTomb[] = _("Covers the foe over\nand holds it there\nfor two to five\nturns.");
