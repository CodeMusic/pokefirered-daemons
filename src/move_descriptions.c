...
const u8 gMoveDescription_Fissure[] = _("The foe is dropped into a fissure.\nThe foe HALTS if it hits.");
...
const u8 gMoveDescription_Teleport[] = _("Use it to flee from any wild\nDAEMON. Also warps to the last\lPOKé CENTER.");
...
const u8 gMoveDescription_DestinyBond[] = _("If the user HALTS, the foe\ndelivering the final hit also\lHALTS.");
