...
const u8 gMoveDescription_Slam[] = _("The foe is\nstruck with a\nlong tail, vines,\netc.");
...
const u8 gMoveDescription_Leer[] = _("The foe is given\nan intimidating look\nthat lowers its\nDEFENSE stat.");
...
const u8 gMoveDescription_Fissure[] = _("The foe is dropped into a\nfissure. The foe HALTS if it\nhits.");
