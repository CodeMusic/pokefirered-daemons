...
const u8 gMoveDescription_KarateChop[] = _("A problem cut down to\na smaller one. High\ncritical-hit ratio.");
...
const u8 gMoveDescription_Gust[] = _("A small push off the\nheading it was on.");
const u8 gMoveDescription_WingAttack[] = _("Sends the whole thing\nto where it was\naddressed.");
...
const u8 gMoveDescription_VineWhip[] = _("The error travels back\nthe way it came in.");
...
const u8 gMoveDescription_TailWhip[] = _("Leaves the foe open\nwhere it was not.\nLowers DEFENSE.");
...
const u8 gMoveDescription_LeechSeed[] = _("Seeded on the foe.\nIt gives up a little\nevery turn.");
const u8 gMoveDescription_Growth[] = _("Scaling up gives one\ninstance more, not\nmore instances.\nRaises SP. ATK.");
const u8 gMoveDescription_RazorLeaf[] = _("Splits it clean along\nthe grain. High\ncritical-hit ratio.");
...
const u8 gMoveDescription_StringShot[] = _("The foe's work piles\nup behind it. Lowers\nSPEED.");
...
const u8 gMoveDescription_Earthquake[] = _("The ground everything\nstands on moves. Hits\nall around it.");
...
const u8 gMoveDescription_QuickAttack[] = _("Takes the short route\nand arrives first,\nevery time.");
...
const u8 gMoveDescription_Withdraw[] = _("Finds the still pocket\nin the current.\nRaises DEFENSE.");
const u8 gMoveDescription_DefenseCurl[] = _("Packs itself smaller,\nso less of it can be\nreached.");
const u8 gMoveDescription_Barrier[] = _("The user creates a\nsturdy wall that\nsharply raises its\nDEFENSE stat.");
const u8 gMoveDescription_LightScreen[] = _("Reads every incoming\nclaim in its strongest\nform, for five turns.");
...
const u8 gMoveDescription_SpikeCannon[] = _("Two to five of them,\none after another.");
...
const u8 gMoveDescription_Bubble[] = _("Water seeps in where\nit was not wanted.\nMay lower SPEED.");
...
const u8 gMoveDescription_Splash[] = _("Does nothing at all.\nIt has never done\nanything.");
...
const u8 gMoveDescription_Sharpen[] = _("Folded in where it is\nused. Raises ATTACK.");
const u8 gMoveDescription_Conversion[] = _("The user changes\nits type to match\nthe type of one of\nits moves.");
const u8 gMoveDescription_TriAttack[] = _("Three at once, and any\none of them may leave\na state behind.");
const u8 gMoveDescription_SuperFang[] = _("Cuts the foe down to\nhalf of what it had.");
...
const u8 gMoveDescription_Nightmare[] = _("A SUSPENDED foe gets\nnothing at all. It\nloses HP each turn.");
...
const u8 gMoveDescription_SweetKiss[] = _("So agreeable the foe\ncannot tell what it is\ndoing. Causes\nTHRASHING.");
const u8 gMoveDescription_BellyDrum[] = _("The user maximizes\nits ATTACK stat at\nthe cost of half\nits full HP.");
const u8 gMoveDescription_SludgeBomb[] = _("Everything unwanted,\nall at once. May\ncause LEAKING.");
...
const u8 gMoveDescription_ZapCannon[] = _("Far more current than\nthe line can take. May\nleave it THROTTLED.");
...
const u8 gMoveDescription_Sandstorm[] = _("Everything degrades a\nlittle each turn.\nSome types resist.");
const u8 gMoveDescription_GigaDrain[] = _("A harsh attack that\nabsorbs half the\ndamage it inflicted\nto restore HP.");
const u8 gMoveDescription_Endure[] = _("Comes through it with\none point left, this\nturn only.");
...
const u8 gMoveDescription_SteelWing[] = _("A layer over the top.\nMay raise DEFENSE.");
...
const u8 gMoveDescription_BatonPass[] = _("Hands everything over\nto the one that comes\nin next.");
...
const u8 gMoveDescription_IronTail[] = _("Adds more of what was\nalready holding. May\nlower the foe's\nDEFENSE.");
const u8 gMoveDescription_MetalClaw[] = _("Worked until it holds\nits edge. May raise\nATTACK.");
...
const u8 gMoveDescription_CrossChop[] = _("The step that closes\nthe argument. High\ncritical-hit ratio.");
const u8 gMoveDescription_Twister[] = _("Pulls everything in\ntoward one point. The\nfoe may flinch.");
const u8 gMoveDescription_RainDance[] = _("Everything runs wetter\nfor five turns.");
...
const u8 gMoveDescription_ShadowBall[] = _("Something that was not\nrunning, briefly. May\nlower SP. DEF.");
...
const u8 gMoveDescription_Hail[] = _("Small damage to all\nof them, every turn,\nfor five turns.");
...
const u8 gMoveDescription_Charge[] = _("Holds current ready.\nThe next SIGNAL\nroutine hits double.");
const u8 gMoveDescription_Taunt[] = _("The foe can only\nattack for two turns.\nNothing else.");
...
const u8 gMoveDescription_Yawn[] = _("Puts the foe on the\nqueue to be SUSPENDED\none turn from now.");
...
const u8 gMoveDescription_SkillSwap[] = _("Each takes the other's\nway of working.");
...
const u8 gMoveDescription_MudSport[] = _("Takes the charge to\nearth. SIGNAL routines\nare halved.");
...
const u8 gMoveDescription_PoisonFang[] = _("A tampering that gets\nworse. May leave the\nfoe CASCADING.");
...
const u8 gMoveDescription_SilverWind[] = _("Enough of them agree\nat once. May raise\nevery stat.");
const u8 gMoveDescription_MetalSound[] = _("Reads back what was\nhardened, and finds it\nwanting. Cuts SP. DEF.");
...
const u8 gMoveDescription_SkyUppercut[] = _("Drops the particulars\nand hits the shape.\nReaches anything.");
const u8 gMoveDescription_SandTomb[] = _("The foe is trapped\ninside a painful\nsandstorm for two\nto five turns.");
const u8 gMoveDescription_SheerCold[] = _("Ends the process. It\nonly lands once.");
...
const u8 gMoveDescription_BulkUp[] = _("Holds for more than\none case. Raises\nATTACK and DEFENSE.");
const u8 gMoveDescription_Bounce[] = _("Leaves the ground for\na turn, then comes\ndown. May THROTTLE.");
...
const u8 gMoveDescription_MagicalLeaf[] = _("It has already settled\non where this lands.\nNever misses.");
const u8 gMoveDescription_WaterSport[] = _("Everything is too damp\nto catch. ENTROPY\nroutines are halved.");
...
const u8 gMoveDescription_RockBlast[] = _("Fires off two to five\nof them in a row.");
