...
#define OBJ_EVENT_PAL_TAG_DAEMON_TYPE_FIRE             (OBJ_EVENT_PAL_TAG_DAEMON_TYPE_BASE + TYPE_FIRE)
#define OBJ_EVENT_PAL_TAG_DAEMON_TYPE_GROUND           (OBJ_EVENT_PAL_TAG_DAEMON_TYPE_BASE + TYPE_GROUND)
#define OBJ_EVENT_PAL_TAG_DAEMON_TYPE_ICE              (OBJ_EVENT_PAL_TAG_DAEMON_TYPE_BASE + TYPE_ICE)
...
#define OBJ_EVENT_PAL_TAG_DAEMON_TYPE_ROCK             (OBJ_EVENT_PAL_TAG_DAEMON_TYPE_BASE + TYPE_ROCK)
...
//  9.4), and no NPC palette has gold, russet, purple and a grey to shade a
//  coat. CRYSTAL and AL are PALSLOT_NPC_SPECIAL, the one slot patched per
//  object from its own tag: NPC_1..4 are refilled from a fixed tag set on
...
static const struct SpritePalette sObjectEventSpritePalettes[] = {
    ...
    {gObjectEventPal_DaemonType_Fire, OBJ_EVENT_PAL_TAG_DAEMON_TYPE_FIRE},
    {gObjectEventPal_DaemonType_Ground, OBJ_EVENT_PAL_TAG_DAEMON_TYPE_GROUND},
    {gObjectEventPal_DaemonType_Ice, OBJ_EVENT_PAL_TAG_DAEMON_TYPE_ICE},
    ...
    {gObjectEventPal_DaemonType_Rock, OBJ_EVENT_PAL_TAG_DAEMON_TYPE_ROCK},
