...
static const u8 sEasyChatWord_Stench[] = _("REPELLENT");
static const u8 sEasyChatWord_ThickFat[] = _("INSULATED");
static const u8 sEasyChatWord_RainDish[] = _("COLLECTS");
static const u8 sEasyChatWord_Drizzle[] = _("HUMIDITY");
static const u8 sEasyChatWord_ArenaTrap[] = _("NO DETACH");
static const u8 sEasyChatWord_Intimidate[] = _("DERATES");
static const u8 sEasyChatWord_RockHead[] = _("NO RECOIL");
...
static const u8 sEasyChatWord_Beauty[] = _("STYLIST");
static const u8 sEasyChatWord_AirLock[] = _("ISOLATED");
static const u8 sEasyChatWord_Psychic[] = _("CONSTRUE");
static const u8 sEasyChatWord_HyperCutter[] = _("PINNED ATK");
static const u8 sEasyChatWord_Fighting[] = _("FIGHTING");
static const u8 sEasyChatWord_ShadowTag[] = _("NO EXIT");
static const u8 sEasyChatWord_Smart[] = _("SMART");
static const u8 sEasyChatWord_Smartness[] = _("SMARTNESS");
static const u8 sEasyChatWord_SpeedBoost[] = _("WARMS UP");
static const u8 sEasyChatWord_Cool[] = _("COOL");
static const u8 sEasyChatWord_Coolness[] = _("COOLNESS");
static const u8 sEasyChatWord_BattleArmor[] = _("CLAMPED");
static const u8 sEasyChatWord_Cute[] = _("CUTE");
static const u8 sEasyChatWord_Cuteness[] = _("CUTENESS");
static const u8 sEasyChatWord_Sturdy[] = _("DURABLE");
static const u8 sEasyChatWord_SuctionCups[] = _("ANCHORED");
static const u8 sEasyChatWord_Grass[] = _("GRASS");
static const u8 sEasyChatWord_ClearBody[] = _("IMMUTABLE");
static const u8 sEasyChatWord_Torrent[] = _("SPILLOVER");
static const u8 sEasyChatWord_Ghost[] = _("GHOST");
static const u8 sEasyChatWord_Ice[] = _("ICE");
static const u8 sEasyChatWord_Guts[] = _("RESILIENT");
static const u8 sEasyChatWord_RoughSkin[] = _("ABRASIVE");
static const u8 sEasyChatWord_ShellArmor[] = _("BOUNDED");
static const u8 sEasyChatWord_NaturalCure[] = _("CLEAN EXIT");
static const u8 sEasyChatWord_Damp[] = _("NO PANIC");
static const u8 sEasyChatWord_Ground[] = _("GROUND");
static const u8 sEasyChatWord_Limber[] = _("NO THROTTLE");
static const u8 sEasyChatWord_MagnetPull[] = _("MAGNETIC");
static const u8 sEasyChatWord_WhiteSmoke[] = _("CONST");
static const u8 sEasyChatWord_Synchronize[] = _("MUTUAL");
static const u8 sEasyChatWord_Overgrow[] = _("OVERFIT");
static const u8 sEasyChatWord_SwiftSwim[] = _("UNERRING SWIM");
static const u8 sEasyChatWord_SandStream[] = _("PARTICULATE");
static const u8 sEasyChatWord_SandVeil[] = _("OBSCURED");
static const u8 sEasyChatWord_KeenEye[] = _("CALIBRATED");
static const u8 sEasyChatWord_InnerFocus[] = _("FOCUSED");
static const u8 sEasyChatWord_Static[] = _("CHARGED");
...
static const u8 sEasyChatWord_ShedSkin[] = _("SELF CLEANS");
static const u8 sEasyChatWord_HugePower[] = _("OVERPOWERED");
static const u8 sEasyChatWord_VoltAbsorb[] = _("VOLT INGEST");
static const u8 sEasyChatWord_WaterAbsorb[] = _("WATER INGEST");
static const u8 sEasyChatWord_Electric[] = _("ELECTRIC");
static const u8 sEasyChatWord_Forecast[] = _("ADAPTIVE");
static const u8 sEasyChatWord_SereneGrace[] = _("SIDE EFFECT");
static const u8 sEasyChatWord_Poison[] = _("POISON");
static const u8 sEasyChatWord_PoisonPoint[] = _("LEAKY");
static const u8 sEasyChatWord_Dragon[] = _("DRAGON");
static const u8 sEasyChatWord_Trace[] = _("INHERITS");
static const u8 sEasyChatWord_Oblivious[] = _("UNPAIRED");
static const u8 sEasyChatWord_Truant[] = _("HALF DUTY");
static const u8 sEasyChatWord_RunAway[] = _("DETACHES");
static const u8 sEasyChatWord_StickyHold[] = _("LOCKED HOLD");
static const u8 sEasyChatWord_CloudNine[] = _("SANDBOXED");
static const u8 sEasyChatWord_Normal[] = _("NORMAL");
static const u8 sEasyChatWord_Steel[] = _("STEEL");
static const u8 sEasyChatWord_Illuminate[] = _("VISIBLE");
static const u8 sEasyChatWord_EarlyBird[] = _("FAST RESUME");
static const u8 sEasyChatWord_Hustle[] = _("UNSAFE OPT");
static const u8 sEasyChatWord_Shine[] = _("SHINE");
static const u8 sEasyChatWord_Flying[] = _("FLYING");
static const u8 sEasyChatWord_Drought[] = _("THERMOSTAT");
static const u8 sEasyChatWord_Lightningrod[] = _("SIGNAL SINK");
static const u8 sEasyChatWord_Compoundeyes[] = _("HIGH RES");
static const u8 sEasyChatWord_MarvelScale[] = _("FAILS SAFE");
static const u8 sEasyChatWord_WonderGuard[] = _("NARROW BAND");
static const u8 sEasyChatWord_Insomnia[] = _("NO SUSPEND");
static const u8 sEasyChatWord_Levitate[] = _("NO ADDRESS");
static const u8 sEasyChatWord_Plus[] = _("SOURCE");
static const u8 sEasyChatWord_Pressure[] = _("COSTLY");
static const u8 sEasyChatWord_LiquidOoze[] = _("BAD SOURCE");
static const u8 sEasyChatWord_ColorChange[] = _("POLYMORPHIC");
static const u8 sEasyChatWord_Soundproof[] = _("MUTED");
static const u8 sEasyChatWord_EffectSpore[] = _("EFFECT PARK");
static const u8 sEasyChatWord_Pkrs[] = _("{PK}RS");
static const u8 sEasyChatWord_Fire[] = _("FIRE");
static const u8 sEasyChatWord_FlameBody[] = _("RUNS HOT");
static const u8 sEasyChatWord_Minus[] = _("SINK");
static const u8 sEasyChatWord_OwnTempo[] = _("NO THRASH");
static const u8 sEasyChatWord_MagmaArmor[] = _("NO HANG");
static const u8 sEasyChatWord_Water[] = _("WATER");
static const u8 sEasyChatWord_WaterVeil[] = _("NO OVERHEAT");
static const u8 sEasyChatWord_Bug[] = _("BUG");
static const u8 sEasyChatWord_Swarm[] = _("SCALE OUT");
static const u8 sEasyChatWord_CuteCharm[] = _("CUTE DOWNCLOCK");
static const u8 sEasyChatWord_Immunity[] = _("NO LEAK");
static const u8 sEasyChatWord_Blaze[] = _("OVERCLOCK");
static const u8 sEasyChatWord_Pickup[] = _("SCAVENGER");
static const u8 sEasyChatWord_Pattern[] = _("PATTERN");
static const u8 sEasyChatWord_FlashFire[] = _("VERBOSE FIRE");
static const u8 sEasyChatWord_VitalSpirit[] = _("ALWAYS ON");
static const u8 sEasyChatWord_Chlorophyll[] = _("SUN CLOCKED");
static const u8 sEasyChatWord_PurePower[] = _("OVERSPEC");
static const u8 sEasyChatWord_ShieldDust[] = _("NO SIDE FX");
