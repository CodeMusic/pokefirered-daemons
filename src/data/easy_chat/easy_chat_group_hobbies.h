...
static const u8 sEasyChatWord_Pc[] = _("PORT");   // T-31: 1.7's PC -> PORT. The last one, and it was here because port_vocab is FENCED OUT of easy chat -- a name table it also learns from.
...
static const u8 sEasyChatWord_Ball[] = _("BOX");
