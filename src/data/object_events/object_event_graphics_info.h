...
//  T-208: the same shape of thing as an item ball -- inanimate, 16x16, no reflection -- and it
//  borrows the ball's own palette slot, so no new palette tag is spent on it.
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_PluginDisc = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_WHITE,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_OldManLyingDown = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_TOWN_CALLOW,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Snorlax = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_DAEMON_TYPE_NORMAL,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_NidoranF = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_DAEMON_TYPE_POISON,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Machop = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_DAEMON_TYPE_FIGHTING,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Cubone = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_DAEMON_TYPE_GROUND,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Owl = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_Owl,
    .affineAnims = gDummySpriteAffineAnimTable,
};

// The BENCHMARK staff and their guide, drawn as a fable (T-116) -- their own sprites, so no shared sheet changes
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_StaffDoldrumSwimmer = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_StaffDoldrumSwimmer,
    .affineAnims = gDummySpriteAffineAnimTable,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_StaffDoldrumPicnicker = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_StaffDoldrumPicnicker,
    .affineAnims = gDummySpriteAffineAnimTable,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_StaffVerdigris = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_StaffVerdigris,
    .affineAnims = gDummySpriteAffineAnimTable,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_StaffQuicksilver = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_StaffQuicksilver,
    .affineAnims = gDummySpriteAffineAnimTable,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BenchmarkGuide = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_BenchmarkGuide,
    .affineAnims = gDummySpriteAffineAnimTable,
};

// CALLOW's child (T-119): a tree frog, in the town's own palette
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TownCallowChild = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_TownCallowChild,
    .affineAnims = gDummySpriteAffineAnimTable,
};

// CALLOW's adult (T-119): a parakeet, in the town's own palette
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TownCallowAdult = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_TownCallowAdult,
    .affineAnims = gDummySpriteAffineAnimTable,
};

// CALLOW's elder (T-119): an old iguana, in the town's own palette
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TownCallowElder = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_TownCallowElder,
    .affineAnims = gDummySpriteAffineAnimTable,
};

// SLATE's child (T-119): a pangolin, in the town's own palette
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TownSlateChild = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_TOWN_SLATE,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    .width = 16,
    .height = 32,
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_TownSlateChild,
    .affineAnims = gDummySpriteAffineAnimTable,
};

// SLATE's adult (T-119): a rock hyrax docent, in the town's own palette
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TownSlateAdult = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_TownSlateAdult,
    .affineAnims = gDummySpriteAffineAnimTable,
};

// SLATE's elder (T-119): an old armadillo, in the town's own palette
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TownSlateElder = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_TownSlateElder,
    .affineAnims = gDummySpriteAffineAnimTable,
};

// DOLDRUM's child (T-119): a seal pup, in the town's own palette
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TownDoldrumChild = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_TOWN_DOLDRUM,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    .width = 16,
    .height = 32,
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_TownDoldrumChild,
    .affineAnims = gDummySpriteAffineAnimTable,
};

// DOLDRUM's adult (T-119): a sea otter, in the town's own palette
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TownDoldrumAdult = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_TownDoldrumAdult,
    .affineAnims = gDummySpriteAffineAnimTable,
};

// DOLDRUM's elder (T-119): an old walrus, in the town's own palette
...
// DOLDRUM's guest (T-119): BLUE redrawn against the town's sixteen, so one map can hold both
...
// T-133: gbaowslots.py variants: the same art, another slot
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Daemon_PikachuS1Reflection = {
    ...
    .width = 16,
    .height = 16,
    .paletteSlot = PALSLOT_NPC_1_REFLECTION,
    .shadowSize = SHADOW_SIZE_M,
    .inanimate = FALSE,
    .disableReflectionPaletteLoad = FALSE,
    .tracks = TRACKS_FOOT,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Daemon_PsyduckS2Reflection = {
    ...
    .width = 16,
    .height = 16,
    .paletteSlot = PALSLOT_NPC_2_REFLECTION,
    .shadowSize = SHADOW_SIZE_M,
    .inanimate = FALSE,
    .disableReflectionPaletteLoad = FALSE,
    .tracks = TRACKS_FOOT,
