...
const u8 gText_QuestLog_MonsWereFullyRestoredAtCenter[] = _("DAEMONS were fully restored at a\nDAEMON CENTER.");
...
const u8 gText_QuestLog_BoughtItem[] = _("Went to the DAEMON MART in\n{DYNAMIC 0x00} and bought one {DYNAMIC 0x01}.");
const u8 gText_QuestLog_BoughtItemsIncludingItem[] = _("Went to the DAEMON MART in\n{DYNAMIC 0x00} and spent ¥{DYNAMIC 0x02} for items including\n{DYNAMIC 0x01}(s).");
const u8 gText_QuestLog_SoldNumOfItem[] = _("{DYNAMIC 0x00} went to the DAEMON MART in\n{DYNAMIC 0x01} and sold {DYNAMIC 0x03} of the item {DYNAMIC 0x02}.");
...
const u8 gText_QuestLog_CaughtWildMons[] = _("Threw POKé BOXES in a frenzy, binding {DYNAMIC 0x04}\nDAEMON including {DYNAMIC 0x03} here in {DYNAMIC 0x00}.");
...
const u8 gText_QuestLog_UsedSweetScent[] = _("{STR_VAR_1} used SWEET SCENT to\nattract wild DAEMON.");
