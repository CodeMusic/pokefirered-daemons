...
static const u8 sColorChangeDescription[] = _("Changes type to remote's move.");
...
static const u8 sIntimidateDescription[] = _("Lowers the remote's ATTACK.");
static const u8 sShadowTagDescription[] = _("Prevents the remote's escape.");
...
static const u8 sPoisonPointDescription[] = _("Poisons remote on contact.");
...
static const u8 sPressureDescription[] = _("Raises remote's PP usage.");
...
static const u8 sFlameBodyDescription[] = _("Burns the remote on contact.");
