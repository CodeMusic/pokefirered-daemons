...
static const u8 sText_NoRunningFromTrainers[] = _("No! There's no running from a USER\nbattle!\p");
...
const u8 gText_OakNoRunningFromATrainer[] = _("CRYSTAL: No! There's no running\naway from a USER DAEMON battle!\p");
...
const u8 gText_BattleMenu[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}FIGHT{CLEAR_TO 56}BAG DAEMON{CLEAR_TO 56}RUN");
