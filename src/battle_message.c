...
const u8 gText_ForPetesSake[] = _("CRYSTAL: Oh, for Pete's sake… So\npushy, as always.\p{B_PLAYER_NAME}.\pYou've never had a DAEMON battle\nbefore, have you?\pA DAEMON battle is when USERS pit\ntheir DAEMON against each other.\p");
const u8 gText_TheTrainerThat[] = _("The USER that makes the other\nUSER's DAEMON HALT by lowering\ltheir HP to “0,” wins.\p");
...
const u8 gText_InflictingDamageIsKey[] = _("CRYSTAL: Inflicting damage on the\nfoe is the key to any battle.\p");
const u8 gText_LoweringStats[] = _("CRYSTAL: Lowering the foe's\nstats will put you at an\ladvantage.\p");
const u8 gText_KeepAnEyeOnHP[] = _("CRYSTAL: Keep your eyes on your\nDAEMON's HP.\pIt will HALT if the HP drops to\n“0.”\p");
const u8 gText_OakNoRunningFromATrainer[] = _("CRYSTAL: No! You cannot DETACH\nfrom a USER engagement!\p");
const u8 gText_WinEarnsPrizeMoney[] = _("CRYSTAL: Hm! Excellent!\pIf you win, you earn prize money,\nand your DAEMON will grow!\pBattle other USERS and make your\nDAEMON strong!\p");
const u8 gText_HowDissapointing[] = _("CRYSTAL: Hm… How disappointing…\pIf you win, you earn prize money,\nand your DAEMONS grow.\pBut if you lose, {B_PLAYER_NAME}, you end\nup paying prize money…\pHowever, since you had no warning\nthis time, I'll pay for you.\pBut things won't be this way once\nyou step outside these doors.\pThat's why you must strengthen your\nDAEMON by battling wild DAEMON.\p");
