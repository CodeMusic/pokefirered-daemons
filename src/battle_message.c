...
static const u8 sText_FoeStoppedWorking[] = _("The remote's\n{B_BUFF1} stopped\lworking!");
...
static const u8 sText_YourFoesWeakGetEmPkmn[] = _("Your remote's\nweak! Get 'em,\l{B_BUFF1}!");
