...
static const u8 sText_UseNextPkmn[] = _("Use next DAEMON?");
...
static const u8 sText_AttackerFainted[] = _("{B_ATK_NAME_WITH_PREFIX} HALTED!\p");
static const u8 sText_TargetFainted[] = _("{B_DEF_NAME_WITH_PREFIX} HALTED!\p");
static const u8 sText_PlayerGotMoney[] = _("{B_PLAYER_NAME} got ¥{B_BUFF1}\nfor winning!\p");
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} is out of usable DAEMON!\p");
...
static const u8 sText_PlayerWhiteoutAgainstTrainer[] = _("{B_PLAYER_NAME} is out of usable DAEMON!\pPlayer lost against {B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_PkmnBadlyPoisoned[] = _("{B_EFF_NAME_WITH_PREFIX} is\ncascading!");
static const u8 sText_PkmnEnergyDrained[] = _("{B_DEF_NAME_WITH_PREFIX} had its\nenergy drained!");
static const u8 sText_PkmnWasBurned[] = _("{B_EFF_NAME_WITH_PREFIX} overheated!");
...
// HUNG's recovery, and the last three places the ice survived. SUSPENDED's
// opposite number is already "resumed!", so this is its pair: a hung process
// that comes back has RESPONDED, and one a move brings back is RESET, which is
// the word WATCHDOG's own description uses.
...
static const u8 sText_PkmnWasDefrostedBy[] = _("{B_ATK_NAME_WITH_PREFIX} was\nreset by {B_CURRENT_MOVE}!");
static const u8 sText_PkmnWasParalyzed[] = _("{B_EFF_NAME_WITH_PREFIX} is throttled!\nIt may stall!");
...
static const u8 sText_PkmnIsParalyzed[] = _("{B_ATK_NAME_WITH_PREFIX} is throttled!\nIt can't act!");
static const u8 sText_PkmnIsAlreadyParalyzed[] = _("{B_DEF_NAME_WITH_PREFIX} is\nalready throttled!");
static const u8 sText_PkmnHealedParalysis[] = _("{B_DEF_NAME_WITH_PREFIX} is no\nlonger throttled!");
...
static const u8 sText_FoeStoppedWorking[] = _("The foe's\n{B_BUFF1} stopped\lworking!");
static const u8 sText_PkmnIsConfused[] = _("{B_ATK_NAME_WITH_PREFIX} is\nthrashing!");
static const u8 sText_PkmnHealedConfusion[] = _("{B_ATK_NAME_WITH_PREFIX} stopped\nthrashing!");
static const u8 sText_PkmnWasConfused[] = _("{B_EFF_NAME_WITH_PREFIX} started\nthrashing!");
static const u8 sText_PkmnAlreadyConfused[] = _("{B_DEF_NAME_WITH_PREFIX} is\nalready thrashing!");
static const u8 sText_PkmnFellInLove[] = _("{B_DEF_NAME_WITH_PREFIX}\nis PAIRED!");
static const u8 sText_PkmnInLove[] = _("{B_ATK_NAME_WITH_PREFIX} is PAIRED\nwith {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnImmobilizedByLove[] = _("{B_ATK_NAME_WITH_PREFIX} will not\nact against its pair!");
...
static const u8 sText_PkmnWentToSleep[] = _("{B_ATK_NAME_WITH_PREFIX} was\nsuspended!");
static const u8 sText_PkmnSleptHealthy[] = _("{B_ATK_NAME_WITH_PREFIX} suspended\nand came back clear!");
...
static const u8 sText_PkmnSqueezedByBind[] = _("{B_DEF_NAME_WITH_PREFIX} was squeezed\nby {B_ATK_NAME_WITH_PREFIX}'s LATCH!");
static const u8 sText_PkmnTrappedInVortex[] = _("{B_DEF_NAME_WITH_PREFIX} was trapped\nin the vortex!");
static const u8 sText_PkmnTrappedBySandTomb[] = _("{B_DEF_NAME_WITH_PREFIX} was\ntrapped by BURY!");
static const u8 sText_PkmnWrappedBy[] = _("{B_DEF_NAME_WITH_PREFIX} was ENCLOSED\nby {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnClamped[] = _("{B_ATK_NAME_WITH_PREFIX} SLUICED\n{B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnFastAsleep[] = _("{B_ATK_NAME_WITH_PREFIX} is\nsuspended.");
static const u8 sText_PkmnWokeUp[] = _("{B_ATK_NAME_WITH_PREFIX} resumed!");
static const u8 sText_PkmnUproarKeptAwake[] = _("But {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s BUSY LOOP\nkept it running!");
static const u8 sText_PkmnWokeUpInUproar[] = _("{B_ATK_NAME_WITH_PREFIX} resumed\nin the BUSY LOOP!");
static const u8 sText_PkmnCausedUproar[] = _("{B_ATK_NAME_WITH_PREFIX} started\na BUSY LOOP!");
static const u8 sText_PkmnMakingUproar[] = _("{B_ATK_NAME_WITH_PREFIX} is running\na BUSY LOOP!");
static const u8 sText_PkmnCalmedDown[] = _("{B_ATK_NAME_WITH_PREFIX} calmed down.");
static const u8 sText_PkmnCantSleepInUproar[] = _("But {B_DEF_NAME_WITH_PREFIX} can't\nsuspend in a BUSY LOOP!");
static const u8 sText_PkmnStockpiled[] = _("{B_ATK_NAME_WITH_PREFIX} ENQUEUED\n{B_BUFF1}!");
...
static const u8 sText_UproarKeptPkmnAwake[] = _("But the BUSY LOOP kept\n{B_DEF_NAME_WITH_PREFIX} running!");
...
static const u8 sText_PkmnFatigueConfusion[] = _("{B_ATK_NAME_WITH_PREFIX} began\nTHRASHING from the work!");
...
// 4.6: PERSPECTIVE is a frame taken, not a shape copied -- and FRAME does
// double duty, a frame of reference and a stack frame, which is exactly
// what one process takes from another.
static const u8 sText_PkmnTransformedInto[] = _("{B_ATK_NAME_WITH_PREFIX} took the frame\nof {B_BUFF1}!");
...
static const u8 sText_PkmnRageBuilding[] = _("{B_DEF_NAME_WITH_PREFIX}'s ACCUMULATE\nis building!");
...
static const u8 sText_PkmnEncoreEnded[] = _("{B_ATK_NAME_WITH_PREFIX}'s\nREPLAY ended!");
static const u8 sText_PkmnTookAim[] = _("{B_ATK_NAME_WITH_PREFIX} took aim\nat {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSketchedMove[] = _("{B_ATK_NAME_WITH_PREFIX} IMPRINTED\n{B_BUFF1}!");
static const u8 sText_PkmnTryingToTakeFoe[] = _("{B_ATK_NAME_WITH_PREFIX} is trying to\ntake its foe with it!");
...
static const u8 sText_PkmnFellIntoNightmare[] = _("{B_DEF_NAME_WITH_PREFIX} was left\nin STARVATION!");
static const u8 sText_PkmnLockedInNightmare[] = _("{B_ATK_NAME_WITH_PREFIX} is held\nin STARVATION!");
static const u8 sText_PkmnLaidCurse[] = _("{B_ATK_NAME_WITH_PREFIX} cut its own HP\nand CONSULTED {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnAfflictedByCurse[] = _("{B_ATK_NAME_WITH_PREFIX} is afflicted\nby the CONSULT!");
static const u8 sText_SpikesScattered[] = _("TRIPWIRE were scattered all\naround the opponent's side!");
...
static const u8 sText_PkmnPerishCountFell[] = _("{B_ATK_NAME_WITH_PREFIX}'s COUNTDOWN\nfell to {B_BUFF1}!");
static const u8 sText_PkmnBracedItself[] = _("{B_ATK_NAME_WITH_PREFIX} braced\nitself!");
static const u8 sText_PkmnEnduredHit[] = _("{B_DEF_NAME_WITH_PREFIX} SURVIVED\nthe hit!");
static const u8 sText_MagnitudeStrength[] = _("TREMOR {B_BUFF1}!");
...
static const u8 sText_PkmnBlewAwaySpikes[] = _("{B_ATK_NAME_WITH_PREFIX} blew\naway TRIPWIRE!");
static const u8 sText_PkmnFledFromBattle[] = _("{B_ATK_NAME_WITH_PREFIX} DETACHED\nfrom battle!");
...
static const u8 sText_PkmnMadeWish[] = _("{B_ATK_NAME_WITH_PREFIX} made a DEFERRED!");
static const u8 sText_PkmnWishCameTrue[] = _("{B_BUFF1}'s DEFERRED\ncame true!");
...
static const u8 sText_PkmnWasMadeDrowsy[] = _("{B_ATK_NAME_WITH_PREFIX} queued\n{B_DEF_NAME_WITH_PREFIX} to suspend!");
...
static const u8 sText_PkmnWantsGrudge[] = _("{B_ATK_NAME_WITH_PREFIX} wants the opponent\nto bear a ZOMBIE!");
static const u8 sText_PkmnLostPPGrudge[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1} lost all\nits MP due to the ZOMBIE!");
...
static const u8 sText_PkmnWaitsForTarget[] = _("{B_ATK_NAME_WITH_PREFIX} waits for its\nfoe to make a move!");
static const u8 sText_PkmnSnatchedMove[] = _("{B_DEF_NAME_WITH_PREFIX} INTERCEPTED\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s routine!");
...
static const u8 sText_PkmnTraced[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} inherited\n{B_BUFF1}'s {B_BUFF2}!");
...
static const u8 sText_PkmnsXInfatuatedY[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nPAIRED {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnsXMadeYIneffective[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nmade {B_CURRENT_MOVE} ineffective!");
// "cured its {B_BUFF1} problem" could not survive the rename: B_BUFF1 fills
// with gText_Paralysis and friends, which are now ADJECTIVES -- so it rendered
// "cured its throttled problem!". Four of the six are adjectives and two are
// gerunds, so no frame holds the word inline. It drops out, and "state" is the
// right noun anyway: 1.6 says a state is something a process is IN.
static const u8 sText_PkmnsXCuredYProblem[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\ncleared its state!");
static const u8 sText_ItSuckedLiquidOoze[] = _("It drew from the\nBAD SOURCE!");
...
static const u8 sText_HMMovesCantBeForgotten[] = _("DRIVER moves can't be\nforgotten now.\p");
...
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}DETACHED.\p");
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} DETACHED\nusing its {B_LAST_ITEM}!\p");
static const u8 sText_PkmnFledUsing[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX}\nDETACHED using\l{B_ATK_ABILITY}!\p");
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE SE_FLEE}Wild {B_BUFF1} DETACHED!");
static const u8 sText_PlayerDefeatedLinkTrainer[] = _("Player outscored\n{B_LINK_OPPONENT1_NAME}!");
...
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} DETACHED!");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} and\n{B_LINK_OPPONENT2_NAME}\lDETACHED!");
static const u8 sText_NoRunningFromTrainers[] = _("No! You cannot DETACH from a\nUSER engagement!\p");
static const u8 sText_CantEscape[] = _("Can't escape!\p");
static const u8 sText_DontLeaveBirch[] = _(""); // Dummied
static const u8 sText_ButNothingHappened[] = _("But nothing happened!");
static const u8 sText_ButItFailed[] = _("But it failed!");
static const u8 sText_ItHurtConfusion[] = _("It hurt itself\nthrashing!");
static const u8 sText_MirrorMoveFailed[] = _("The REROUTE failed!");
...
static const u8 sText_FailedToSpitUp[] = _("But EVICT ALL had\nnothing to send!");
static const u8 sText_FailedToSwallow[] = _("But DEQUEUE had\nnothing to take!");
static const u8 sText_WindBecameHeatWave[] = _("The wind turned\ninto a SCRAMBLE!");
...
static const u8 sText_FaintInThree[] = _("All affected DAEMON will HALT in\nthree turns!");
static const u8 sText_NoPPLeft[] = _("There's no MP left\nfor this move!\p");
static const u8 sText_ButNoPPLeft[] = _("But there was no MP\nleft for the move!");
...
static const u8 sText_PkmnBeganToNap[] = _("{B_ATK_NAME_WITH_PREFIX} idled!");
...
static const u8 sText_EnemyAboutToSwitchPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} is about to use {B_BUFF2}.\pWill {B_PLAYER_NAME} change DAEMON?");
static const u8 sText_PkmnLearnedMove2[] = _("{B_ATK_NAME_WITH_PREFIX} learned\n{B_BUFF1}!");
//  THE PLAYER'S NAME, not the word "Player": this closes every trainer battle a player wins (STRINGID_PLAYERDEFEATEDTRAINER1),
//  and vanilla's literal "Player" sat one line above "{B_PLAYER_NAME} got $80 for winning!" (seen playing CONTEXT, 2026-09-25).
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("{B_PLAYER_NAME} outscored\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!\p");
...
static const u8 sText_YourFoesWeakGetEmPkmn[] = _("Your foe's\nweak! Get 'em,\l{B_BUFF1}!");
...
static const u8 sText_FoePkmnPrefix[] = _("Remote ");
static const u8 sText_FoePkmnPrefix2[] = _("Remote");
static const u8 sText_AllyPkmnPrefix[] = _("Ally");
static const u8 sText_FoePkmnPrefix3[] = _("Remote");
static const u8 sText_AllyPkmnPrefix2[] = _("Ally");
static const u8 sText_FoePkmnPrefix4[] = _("Remote");
static const u8 sText_AllyPkmnPrefix3[] = _("Ally");
// The menu says INVOKE and this said "used" -- the verb the player presses and
// the verb the game reports, disagreeing on the most-read line in the game.
// 1.6: "you bind() a daemon and you INVOKE it", and a ROUTINE is a subroutine,
// which is exactly the thing you invoke. ITEMS are still USED, below: you use a
// thing and you invoke a procedure, and keeping those apart is the distinction.
// Measured at 145px worst case -- "Remote " plus a ten-character nickname plus
// "invoked" -- against the 196px box.
static const u8 sText_AttackerUsedX[] = _("{B_ATK_NAME_WITH_PREFIX} invoked\n{B_BUFF2}");
...
static const u8 sText_PokedudeUsedItem[] = _("The TUTOR used\n{B_LAST_ITEM}!");
static const u8 sText_Trainer1UsedItem[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nused {B_LAST_ITEM}!");
static const u8 sText_TrainerBlockedBall[] = _("The USER blocked the BOX!");
static const u8 sText_DontBeAThief[] = _("Don't be a thief!");
static const u8 sText_ItDodgedBall[] = _("It dodged the thrown BOX! This\nDAEMON can't be bound!");
static const u8 sText_YouMissedPkmn[] = _("You missed the DAEMON!");
static const u8 sText_PkmnBrokeFree[] = _("Oh, no! The DAEMON broke free!");
static const u8 sText_ItAppearedCaught[] = _("Aww! It appeared to be bound!");
...
static const u8 sText_GotchaPkmnCaught[] = _("Gotcha! {B_OPPONENT_MON1_NAME} was bound!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p");
static const u8 sText_GotchaPkmnCaught2[] = _("Gotcha! {B_OPPONENT_MON1_NAME} was bound!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}{PAUSE 127}");
static const u8 sText_GiveNicknameCaptured[] = _("Give a nickname to the\ncaptured {B_OPPONENT_MON1_NAME}?");
static const u8 sText_PkmnSentToPC[] = _("{B_OPPONENT_MON1_NAME} was sent\nto {B_PC_CREATOR_NAME} PORT.");
static const u8 sText_Someones[] = _("someone's");
static const u8 sText_Bills[] = _("HOLT's");
static const u8 sText_PkmnDataAddedToDex[] = _("{B_OPPONENT_MON1_NAME}'s data was added to the INDEX.\p");
static const u8 sText_ItIsRaining[] = _("It is raining."); // used only in RSE when a battle starts in a rainy area
static const u8 sText_SandstormIsRaging[] = _("A sandstorm is raging.");
static const u8 sText_BoxIsFull[] = _("The BOX is full! You can't bind any\nmore!\p");
...
static const u8 sText_PkmnHungOnWithX[] = _("{B_DEF_NAME_WITH_PREFIX} stayed up\nusing its {B_LAST_ITEM}!");
...
static const u8 sText_PkmnHearingFluteAwoke[] = _("The DAEMON hearing the FLUTE\nresumed!");
static const u8 sText_YouThrowABallNowRight[] = _("You throw a BOX now, right?\nI… I'll do my best!");
const u8 gText_ForPetesSake[] = _("CRYSTAL: Already. Of course it is.\p{B_PLAYER_NAME}.\pYou have not done this before.\pTwo USERS. Two DAEMONS. Each one\nruns until the other halts.\p");
const u8 gText_TheTrainerThat[] = _("Bring its HP to “0,” and it halts.\nThat is all there is to it.\p");
const u8 gText_TryBattling[] = _("I could explain the rest. It would\ntake longer than doing it.\pSo do it.\p");
const u8 gText_InflictingDamageIsKey[] = _("CRYSTAL: Write to it. A battle is\ndecided by what gets written.\p");
const u8 gText_LoweringStats[] = _("CRYSTAL: Take something away from\nit, and what you have is worth\lmore.\p");
const u8 gText_KeepAnEyeOnHP[] = _("CRYSTAL: Watch your DAEMON's HP.\pAt “0,” it HALTS.\p");
const u8 gText_OakNoRunningFromATrainer[] = _("CRYSTAL: No. You do not DETACH\nfrom another USER.\p");
const u8 gText_WinEarnsPrizeMoney[] = _("CRYSTAL: Hm. Good.\pWin, and you are paid, and your\nDAEMON grows.\pThere are other USERS. Find out\nwhat it does against them.\p");
const u8 gText_HowDissapointing[] = _("CRYSTAL: Hm.\pWin, and you are paid, and your\nDAEMONS grow.\pLose, {B_PLAYER_NAME}, and you pay.\pNobody warned you. So this time,\nI will pay.\pOutside that door, nobody will.\pLet it run against wild DAEMONS\nfirst. It learns there.\p");
...
const u8 gText_SafariBalls[] = _("{HIGHLIGHT 2}GUESTBOXES"); //
const u8 gText_HighlightRed_Left[] = _("{HIGHLIGHT 2}Left: ");
const u8 gText_HighlightRed[] = _("{HIGHLIGHT 2}");
const u8 gText_Sleep[] = _("suspended");
const u8 gText_Poison[] = _("leaking");
const u8 gText_Burn[] = _("overheated");
const u8 gText_Paralysis[] = _("throttled");
const u8 gText_Ice[] = _("hung");
const u8 gText_Confusion[] = _("thrashing");
...
static const u8 sText_Trainer1Fled[] = _("{PLAY_SE SE_FLEE}{B_TRAINER1_CLASS} {B_TRAINER1_NAME} DETACHED!");
