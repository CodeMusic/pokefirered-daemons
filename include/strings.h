...
extern const u8 gTeachyTvString_Hosting[];
extern const u8 gTeachyTvString_Mark1[];
extern const u8 gTeachyTvString_Mark2[];
extern const u8 gTeachyTvString_Mark3[];
extern const u8 gTeachyTvString_Mark4[];
extern const u8 gTeachyTvString_Mark5[];
extern const u8 gTeachyTvString_Mark6[];
extern const u8 gTeachyTvString_Mark7[];
extern const u8 gTeachyTvString_Mark8[];
extern const u8 gTeachyTvText_TutorSaysHelloNewShow[];
extern const u8 gTeachyTvText_HostingScript1[];
extern const u8 gTeachyTvText_HostingScript2[];
extern const u8 gTeachyTvText_Mark1Script1[];
extern const u8 gTeachyTvText_Mark1Script2[];
extern const u8 gTeachyTvText_Mark2Script1[];
extern const u8 gTeachyTvText_Mark2Script2[];
extern const u8 gTeachyTvText_Mark3Script1[];
extern const u8 gTeachyTvText_Mark3Script2[];
extern const u8 gTeachyTvText_Mark4Script1[];
extern const u8 gTeachyTvText_Mark4Script2[];
extern const u8 gTeachyTvText_Mark5Script1[];
extern const u8 gTeachyTvText_Mark5Script2[];
extern const u8 gTeachyTvText_Mark6Script1[];
extern const u8 gTeachyTvText_Mark6Script2[];
extern const u8 gTeachyTvText_Mark7Script1[];
extern const u8 gTeachyTvText_Mark7Script2[];
extern const u8 gTeachyTvText_Mark8Script1[];
extern const u8 gTeachyTvText_Mark8Script2[];
...
extern const u8 gText_DbgMenuDiploma[];
extern const u8 gText_DbgMenuDoldrum[];
extern const u8 gText_DbgMenuArtsai[];
extern const u8 gText_DbgMenuCrystal[];
extern const u8 gText_DbgMenuWarden[];
extern const u8 gText_DbgMenuJump[];
extern const u8 gText_DbgMenuEncounter[];
extern const u8 gText_DbgMenuDaemon[];
extern const u8 gText_DbgMenuLevel[];
extern const u8 gText_DbgMenuInvoke[];
extern const u8 gText_DbgMenuSong[];
extern const u8 gText_DbgMenuSfx[];
extern const u8 gText_DbgMenuWatch[];
extern const u8 gText_DbgSun[];
extern const u8 gText_DbgMon[];
extern const u8 gText_DbgTue[];
extern const u8 gText_DbgWed[];
extern const u8 gText_DbgThu[];
extern const u8 gText_DbgFri[];
extern const u8 gText_DbgSat[];
extern const u8 gText_DbgWatchAuto[];
extern const u8 gText_DbgWatchDay[];
extern const u8 gText_DbgWatchDusk[];
extern const u8 gText_DbgWatchNight[];
extern const u8 gText_DbgWatchDawn[];
...
extern const u8 gStartMenuDesc_DbgDiploma[];
extern const u8 gStartMenuDesc_DbgDoldrum[];
extern const u8 gStartMenuDesc_DbgArtsai[];
extern const u8 gStartMenuDesc_DbgCrystal[];
extern const u8 gStartMenuDesc_DbgWarden[];
...
extern const u8 gStartMenuDesc_DbgInvoke[];
extern const u8 gStartMenuDesc_DbgSong[];
extern const u8 gStartMenuDesc_DbgSfx[];
extern const u8 gStartMenuDesc_DbgWatch[];
...
extern const u8 gText_DayNoteC[];
extern const u8 gText_DayNoteD[];
extern const u8 gText_DayNoteE[];
extern const u8 gText_DayNoteF[];
extern const u8 gText_DayNoteG[];
extern const u8 gText_DayNoteA[];
extern const u8 gText_DayNoteB[];
extern const u8 gText_DayBannerDot[];
extern const u8 gText_DaySunday[];
extern const u8 gText_DayMonday[];
extern const u8 gText_DayTuesday[];
extern const u8 gText_DayWednesday[];
extern const u8 gText_DayThursday[];
extern const u8 gText_DayFriday[];
extern const u8 gText_DaySaturday[];
extern const u8 gText_WatchDay[];
extern const u8 gText_WatchDusk[];
extern const u8 gText_WatchNight[];
extern const u8 gText_WatchDawn[];
