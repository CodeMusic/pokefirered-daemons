...
extern const u32 gTrainerFrontPic_StaffSlate[];
extern const u32 gTrainerPalette_StaffSlate[];
extern const u32 gTrainerFrontPic_StaffDoldrumSwimmer[];
extern const u32 gTrainerPalette_StaffDoldrumSwimmer[];
extern const u32 gTrainerFrontPic_StaffDoldrumPicnicker[];
extern const u32 gTrainerPalette_StaffDoldrumPicnicker[];
extern const u32 gTrainerFrontPic_StaffArdor[];
extern const u32 gTrainerPalette_StaffArdor[];
extern const u32 gTrainerFrontPic_StaffVerdigris[];
extern const u32 gTrainerPalette_StaffVerdigris[];
extern const u32 gTrainerFrontPic_StaffLurid[];
extern const u32 gTrainerPalette_StaffLurid[];
extern const u32 gTrainerFrontPic_StaffBrazen[];
extern const u32 gTrainerPalette_StaffBrazen[];
extern const u32 gTrainerFrontPic_StaffQuicksilver[];
